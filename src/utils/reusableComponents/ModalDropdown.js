...
import { FlatList, StyleSheet, Dimensions, View, Text, TouchableWithoutFeedback, TouchableNativeFeedback, TouchableOpacity, TouchableHighlight, Modal, ActivityIndicator } from 'react-native';
...
export default class ModalDropdown extends Component {
  ...
  _renderRow = ({ item: rowData, index: rowID, separators }) => {
    ...
    const row = !renderRow ? (
      <Text style={[styles.rowText, dropdownTextStyle, highlighted && styles.highlightedRowText, highlighted && dropdownTextHighlightStyle]}>{rowData}</Text>
    ) : (
    ...
    props.key = key;
    props.onPress = () => this._onRowPress(rowData, rowID);
